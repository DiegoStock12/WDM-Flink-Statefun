...
CreateItemWithId = _reflection.GeneratedProtocolMessageType('CreateItemWithId', (_message.Message,), dict(
...
StockRequest = _reflection.GeneratedProtocolMessageType('StockRequest', (_message.Message,), dict(
  ...
  SubtractItemStockRequest = _reflection.GeneratedProtocolMessageType('SubtractItemStockRequest', (_message.Message,), dict(
  ...
  AddItemStockRequest = _reflection.GeneratedProtocolMessageType('AddItemStockRequest', (_message.Message,), dict(
